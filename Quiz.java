...
public class Quiz extends JFrame implements ActionListener {
	...
	Quiz(String name){
		...
		opt1.setBounds(130,320,700,30);
		opt1.setFont(new Font("Dialog",Font.PLAIN,20));
		opt1.setBackground(Color.cyan);
		add(opt1);
		
		 opt2 = new JRadioButton();
		opt2.setBounds(130,380,700,30);
		opt2.setFont(new Font("Dialog",Font.PLAIN,20));
		opt2.setBackground(Color.cyan);
		add(opt2);

		 opt3 = new JRadioButton();
		opt3.setBounds(130,440,700,30);
		...
		next.setBounds(1000,320,240,40);
		next.setBackground(Color.BLACK);
		next.setForeground(Color.cyan);
		next.setFont(new Font("Copperplate Gothic Bold",Font.ITALIC, 22));
		next.addActionListener(this);
		add(next);
		
		 lifeline = new JButton("50 50 LifeLine");
		lifeline.setBounds(1000,400,240,40);
		lifeline.setBackground(Color.BLACK);
		lifeline.setForeground(Color.cyan);
		lifeline.setFont(new Font("Copperplate Gothic Bold",Font.ITALIC, 22));
		lifeline.addActionListener(this);
		add(lifeline);
		
		 submit = new JButton("Submit");
		submit.setBounds(1000,480,240,40);
	...
	public  void paint (Graphics g) {
		...
		g.setFont(new Font("Copperplate Gothic Bold",Font.ITALIC ,25 ));
		
		if (timer>0) {
			g.drawString(time, 950, 98);
		}else {
			g.drawString("times up!!", 950, 98);
